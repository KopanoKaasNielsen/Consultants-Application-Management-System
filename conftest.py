...
SKIP_DJANGO_SETUP = os.getenv("SKIP_DJANGO_SETUP") == "1"
...
if not SKIP_DJANGO_SETUP:
    ...
    @pytest.fixture
    def user_factory():  # pragma: no cover - not used outside Django context
        pytest.skip("Django setup skipped", allow_module_level=False)
